    ...
    def check_banned_words(self, args):
        for word in ("ascii", "utf8"):
            with suppress(Exception):
                ...
                [args.subClient.send_message(args.chatId,message=f"<$@{args.author}$> don't use this word",mentionUserIds=[args.authorId]) for elem in para if elem in args.subClient.banned_words]
